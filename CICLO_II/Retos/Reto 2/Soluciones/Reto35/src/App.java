...
public class App {
    ...
    public static int getExamsRegular(Persona[] data){
        int count = 0;
        for(int i = 0; i < data.length; i++){
    ...
    public static double getExamsPercentajeRegular(Persona[] data){
        return (double)(getExamsRegular(data)) / data.length;
    }

    public static int getWorstSubjectForMales(Persona[] data){
