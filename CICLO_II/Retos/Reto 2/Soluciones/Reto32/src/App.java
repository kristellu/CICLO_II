...
public class App {
    ...
    public static void readData(){
        ...
        for(int i = 0; i < n/3; i++){
            ...
            data[i] = new Persona(id, gen, notaH, notaL, notaB);
        }
        scanLine.close();
    }
    ...
    public static int getExamsDeficient(Persona[] data){
        int count = 0;
        for(int i = 0; i < data.length; i++){
    ...
    public static int getBetterPerformingSubjectGroup(Persona[] data){
