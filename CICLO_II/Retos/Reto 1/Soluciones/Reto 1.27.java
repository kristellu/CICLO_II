...
public class Reto27 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        print(getTestsPerformanceUnderAvg(data));
    ...
    public static int getTestsPerformanceUnderAvg(double[][] data){
        int count = 0;
    ...
    public static double getExamsPercentajeOutstanding(double[][] data){
