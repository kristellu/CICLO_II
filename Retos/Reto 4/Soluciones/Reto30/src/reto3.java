...
// Â¿Cuantos de los examenes tienen una calificaciÃ³n mayor a la del promedio del grupo?
// Â¿CuÃ¡ntos examenes tienen una calificaciÃ³n Sobresaliente?
// Â¿CuÃ¡l es la materia con el mayor numero de examenes aprobados?
// Â¿CuÃ¡l es el estudiante con el mejor desempeÃ±o para la materia idiomas?
...
public class reto3 {
    ...
    public static void main(String[] args) throws Exception {
       ...
       /* Estudiante es = new Estudiante(1.0, "Karen", 1.0, 2.9, 3.0, 4.1);
        es.addEstudiante();*/
    }
    ...
    public static void readData(){
        ...
        for(int i = 0; i < n/3; i++){
            ...
            data[i] = new Estudiante(id, students[idInt-1], gen, notaI, notaH, notaL);
        }
    ...
    // 'Â¿CuÃ¡l es el desempeÃ±o promedio de todo el grupo?'
