...
public class controller {
    ...
    void clickProcessButton(ActionEvent event) {
        ...
        for (int i = 0; i < pacientes.length; i++) {
            ...
            richTextField2.setText(richTextField2.getText() + string);
        }
        ...
        switch (numM) {
            ...
            case 2:
                ...
                richTextField2.setText(richTextField2.getText() + "Taenia saginata" + "\n");
                break;
            case 3:
        ...
        richTextField2.setText(richTextField2.getText() + pacSD + "\n");
