...
public class App {
    ...
    public static double getTestsPerformanceOverAvg(Persona[] data){
        double sum = 0;
        for(int i = 0; i < data.length; i++){
    ...
    public static double geExamsPercentajeExcellent(Persona[] data){
        return (double)(getExamsExcellent(data)) / data.length;
    }

    public static int getWorseSubjectGroup(Persona[] data){
