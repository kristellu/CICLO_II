...
public class Reto36 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        print(students[getStudentWorstGradeBySubject(data)[0] -1]);
    }
    ...
    public static int getTestsFailed(double[][] data){
        int count = 0;
        for(int i = 0; i < data.length; i++){
            if(gradingScale[1][1] >= data[i][3])
                count++;
        }
        return count;
    }
    ...
    public static int getSubjectMostApprobedExams(double[][] data){
    ...
    public static int[] getStudentWorstGradeBySubject(double[][] data){
        double[] subjectsMax = {10000,10000,1000};
