...
public class Reto84 {
    ...
    public static float[] getAverageAndMin(float[] arr) {
        int tot = 0;
    ...
    public static void main(String[] args) throws Exception {
        ...
        float[] avgAndMin = new float[2];
        avgAndMin = getAverageAndMin(noduleSizes);
        String avgNoduleSize = String.format("%.2f", avgAndMin[0]);
        float minNoduleSize = avgAndMin[1];
        System.out.println(avgNoduleSize);
        System.out.println(minNoduleSize);
    }
}